...
3. _myDesk_ is the main app of the project and is essentially a dashboard (myDesk/templates/myDesk/index.html) where employees see their vacation status and can send a new request and managers can process them.
